...
<div class="container">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.code==100){
                        ...
                        $("#emp_save_btn").attr("ajax-email-va","success");
                    }else{
                        show_validate_msg("#email_add_input","error",result.extend.va_msg);
                        $("#emp_save_btn").attr("ajax-email-va","error");
                    }
                }
            });
        });
        ...
        $("#emp_save_btn").click(function(){
            ...
            //1、先对要提交给服务器的数据进行校验 这里又在前端校验格式是否正确，会覆盖掉存在性校验的样式，所以不应该这样写，直接用后段校验格式
            ...
            if($(this).attr("ajax-email-va")=="error"){
                return false;
            }
            ...
            // empName=123141&email=1%40cr.com&gender=M&dId=1
